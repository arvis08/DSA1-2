...
//        System.out.println(Arrays.deepToString(arr));
    ...
    public static List<Integer> spiralDisp(int[][] arr) {
        int count = 0, sr = 0, sc = 0, er = arr.length - 1, ec = arr[0].length - 1, total = arr.length * arr[0].length;
    ...
    public static boolean srch2dMatrix(int[][] arr, int tar) {
...
//      int pressedButton=Integer.parseInt(String.valueOf(s.charAt(i)));
